...
namespace NTP3
{
    public class AnalysisExportColumn
    {
        public AnalysisResultsRecordField Field { get; }

        public AnalysisResultsRecordSubfield Subfield { get; }

        public AnalysisExportColumn(
